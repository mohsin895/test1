<template>
    <HospitalLayout>
        <div class="mb-8 border-b pb-4 text-2xl font-bold"></div>
        <div class="mb-7">
            ...
            <div class="flex justify-between mb-5">
                ...
                <div class="flex items-center gap-5 font-semibold">
                    Show weeks
                    <Input.Primary v-model="weeks" type="number" class="border" />
                </div>
            </div>
            ...
            <div class="mt-5">
                ...
                <div class="mt-5">
                    <div class="max-w-[400px] mx-auto mt-4 border p-5 border-primary grid gap-5 rounded-md shadow-xl shadow-primary/10">
...
import { convert24to12 } from '@/helper'
...
watch(weeks, () => {
    ...
    timeout = setTimeout(() => {
        router.visit(route('hospitals.doctors.calender', {
            id: props.doctor.id,
            weeks: weeks.value
        }))
    }, 1000)
...
const save_appointment_control = () => {
    ...
    appointment_control_form.post(route('hospitals.doctors.save_appointment_control', props.doctor.id))
}
...
const handleSave = () => {
    ...
    form.post(route('hospitals.doctors.save_calender', props.doctor.id), {
        onSuccess(e) {
