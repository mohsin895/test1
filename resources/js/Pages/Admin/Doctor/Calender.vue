...
watch(weeks, () => {
    ...
    timeout = setTimeout(() => {
        router.visit(route('app.doctors.calender', {
            id: props.doctor.id,
            weeks: weeks.value
        }))
    }, 1000)
...
const save_appointment_control = () => {
    ...
    appointment_control_form.post(route('app.doctors.save_appointment_control', props.doctor.id))
}
...
const handleSave = () => {
    ...
    form.post(route('app.doctors.save_calender', props.doctor.id), {
        onSuccess(e) {
