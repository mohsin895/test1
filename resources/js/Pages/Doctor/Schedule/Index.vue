                ...
                <div class="flex flex-wrap gap-12 md:gap-8 mt-5">
                    ...
                    >
                        ...
                        <div class="flex absolute -bottom-3 left-1/2 -translate-x-1/2 justify-center">
                            <Link
                                :href="route('doctor.schedule.visitation', slot.id)"
                        ...
                        <div v-if="!chamber.slots" class="text-center font-semibold text-slate-500 text-xl">
                No Schedule found
            </div>
                    </div>
                </div>
...
const handleSave = (slot, doctor_id) => {
    ...
    Helper.confirm('Are you sure to update start time?', () => {
        ...
        modify_form.post(route('doctor.schedule.update'), {
            onFinish() {
                modify_form.reset()
            }
        })
