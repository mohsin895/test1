<template>
    ...
    <button 
        v-else
        class="px-4 py-1 whitespace-nowrap rounded border shadow hover:shadow-lg active:scale-95 duration-300 select-none inline-flex items-center justify-center gap-1"
        :class="loading ? 'pointer-events-none opacity-70' : ''"
    >
        <slot></slot>
...
<script setup>
    ...
    import { Loader } from '@/plugins/tableSchudle'
    defineProps({
        loading: {
            type: Boolean,
            default: false,
