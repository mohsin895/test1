...
class DoctorController extends Controller
{
    ...
    public function index()
    {
        ...
        $data = User::where('role', 'doctor')->orderBy('id', 'desc')->get();
        $roles = Role::all();

        return Inertia::render('Admin/Doctor/Index', compact('data', 'roles'));
    }
    ...
    public function configurations($id)
    {
        ...
        return Inertia::render('Admin/Doctor/Configurations', compact('chambers', 'doctor', 'medicals', 'designations', 'specializations', 'degrees', 'week_days'));
    }
    ...
    public function calender(Request $request, $id)
    {
        ...
        return Inertia::render('Admin/Doctor/Calender', compact('doctor', 'active_dates', 'slots', 'weeks'));
    }
